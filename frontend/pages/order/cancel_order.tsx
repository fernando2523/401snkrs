...
export default function Shipping() {
    ...
    const { data, error, isLoading } = useSWR(`https://api.epseugroup.com/orders/0/10/CANCEL/${Query}`, fetcher);
                                        ...
                                        rows.push(
                                            <div key={i} className="flex justify-start items-start gap-7">
                                                <Image
                                                    ...
                                                    // src="/produk.jpg"
                                                    src={`https://lokigudang.com/apiupload/${order.details_order[i - 1].img}`}
                                                    alt="product-1"
                                                    height="500"
                                                    width="500"
                                                    priority
