...
export default function PageSo() {
    ...
    async function loaddatapo(query: any, tanggal: any, Filter_Tipe_po: any, Filter_Supplier: any, Filter_Tipe_user: any, Filter_Tipe_warehouse: any) {
        ...
        await axios({
            method: "post",
            url: `https://api.401snkrs.com/v1/getpotransfer`,
            data: {
                query: query,
                date: tanggal,
    ...
    async function getusers(user_login: any, user_role: any) {
        ...
        await axios({
            method: "post",
            url: `https://api.401snkrs.com/v1/getusertransfer`,
            data: {
    ...
    async function getwarehouse(date: any, user_login: any, Filter_Tipe_user: any) {
        ...
        await axios({
            method: "post",
            url: `https://api.401snkrs.com/v1/getwarehousetransfers`,
            data: {
                date: date,
                user_login: user_login,
                Filter_Tipe_user: Filter_Tipe_user,
    ...
    const onSubmitedit = async (data: any) => {
        ...
        if (qty_all === 0) {
            ...
            await axios
                .post(`https://api.401snkrs.com/v1/edittransfer`, {
                    data: data,
                    id_act: id_act,
                    idpo: edit_idpo,
