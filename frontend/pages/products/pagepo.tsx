...
export default function PageSo() {
  ...
  async function loaddatapo(query: any, tanggal: any, Filter_Tipe_po: any, Filter_Supplier: any, Filter_Tipe_user: any) {
    ...
    await axios({
      method: "post",
      url: `https://api.epseugroup.com/v1/getpo`,
      data: {
        query: query,
        date: tanggal,
  ...
  async function getusers(user_login: any, user_role: any) {
    ...
    await axios({
      method: "post",
      url: `https://api.epseugroup.com/v1/getuserpo`,
      data: {
  ...
  async function deleteData() {
    await axios
      .post(`https://api.epseugroup.com/v1/deleteitem`, {
        id_act: id_act,
      })
      .then(function (response) {
        loaddatapo(Query, date, Filter_Tipe_po, Filter_Supplier, Filter_Tipe_user);
  ...
  async function showrepeatModal(
    ...
    console.log(id_act)
    await axios
      .post(`https://api.epseugroup.com/v1/get_sizepo`, {
        id_act: id_act,
      })
      .then(function (response) {
  ...
  const onSubmitedit = async (data: any) => {
    ...
    if (qty_all === 0) {
      ...
      await axios
        .post(`https://api.epseugroup.com/v1/editpo`, {
          data: data,
          id_act: id_act,
          idpo: edit_idpo,
