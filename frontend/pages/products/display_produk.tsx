...
export default function DaftarProduk() {
    ...
    async function loaddataproduk(store: any, query: any, area: any, Role: any, loadmorelimit: any) {
        ...
        await axios({
            method: "post",
            url: `https://api.401snkrs.com/v1/getprodukdisplay`,
            data: {
                store: store,
                query: query,
                area: area,
    ...
    async function getwarehouse(Role: any, area: any) {
        await axios({
            method: "post",
            url: `https://api.401snkrs.com/v1/getwarehousedisplayproduct`,
            data: {
                role: Role,
                store: area,
                idware: getwaress,
    ...
    const onSubmitUpdate = async (data: any) => {
        await axios
            .post(`https://api.401snkrs.com/v1/add_display`, {
    ...
    async function deleteData() {
        await axios
            .post(`https://api.401snkrs.com/v1/delete_display`, { id, idware })
            .then(function (response) {
                loaddataproduk(Store, Query, area, Role, loadmorelimit);
                getwarehouse(Role, area);
                getstore(Role, area);
    ...
    async function printSo() {
        if (warehouse_so === "") {
            ...
            // window.open(`https://api.401snkrs.com/v1/print_stockopname/${warehouse_so}`, '_blank');
