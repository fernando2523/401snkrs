...
export default function Shipping() {
  ...
  async function loaddataorder(
    ...
    await axios({
      method: "post",
      url: `https://api.401snkrs.com/v1/orderresellerretail`,
      data: {
  ...
  async function ordercount(store: any, query: any, date: any, area: any) {
    await axios({
      method: "post",
      url: `https://api.401snkrs.com/v1/ordercountresellerretail`,
      data: {
        store: store,
        query: query,
        date: date,
  ...
  async function getheaderpesanan(
    ...
    await axios({
      method: "post",
      url: `https://api.401snkrs.com/v1/getheaderpesananresellerretail`,
      data: {
        status_pesanan: status_pesanan,
        query: query,
        store: store,
