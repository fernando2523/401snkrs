...
export default function Warehouse() {
  ...
  const onSubmit = async (data: any) => {
    await axios
      .post("https://api.401snkrs.com/v1/addwarehouse", data)
      .then(function (response) {
  ...
  const onSubmitUpdate = async (data: any) => {
    await axios
      .post(`https://api.401snkrs.com/v1/editwarehouse`, { data, id })
      .then(function (response) {
        console.log(response.data);
        loaddatawarehouse();
      });
  ...
  async function deleteData() {
    await axios
      .post(`https://api.401snkrs.com/v1/deletewarehouse`, { id })
      .then(function (response) {
        console.log(response.data);
        loaddatawarehouse();
      });
        ...
        action: (
          <div className="flex flex-warp gap-4">
            ...
            <button
              ...
              onClick={() => showdeleteModal(data_ware.id, index)}
            >
      ...
      <div className="flex flex-wrap items-center content-center mb-6">
        <div className="shadow rounded-lg w-auto flex flex-row text-center content-center">
          <input
            ...
            type="text"
            placeholder="Cari data Warehouse"
            value={filterText}
