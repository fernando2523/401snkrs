...
export default function Reseller() {
  ...
  async function loaddatareseller() {
    ...
    await axios({
      method: "get",
      url: `https://api.401snkrs.com/v1/getreseller`,
    })
  ...
  const onSubmit = async (data: any) => {
    await axios
      .post("https://api.401snkrs.com/v1/addreseller", data)
      .then(function (response) {
        // console.log(response.data);
        loaddatareseller();
      });
  ...
  const onSubmitUpdate = async (data: any) => {
    await axios
      .post(`https://api.401snkrs.com/v1/editreseller`, { data, id })
      .then(function (response) {
        // console.log(response.data);
        loaddatareseller();
      });
  ...
  async function deleteData() {
    await axios
      .post(`https://api.401snkrs.com/v1/deletereseller`, { id })
      .then(function (response) {
        // console.log(response.data);
        loaddatareseller();
      });
