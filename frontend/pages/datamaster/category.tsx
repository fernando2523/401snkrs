...
export default function Category() {
  ...
  async function loaddatacategory() {
    ...
    await axios({
      ...
      .then(function (response) {
        ...
        setisLoading(false);
        // console.log(response.data.data_category);
      })
  ...
  const onSubmit = async (data: any) => {
    await axios
      .post("https://api.401snkrs.com/v1/addcategory", data)
      .then(function (response) {
  ...
  const onSubmitUpdate = async (data: any) => {
    await axios
      .post(`https://api.401snkrs.com/v1/editcategory`, { data, id })
      .then(function (response) {
        // console.log(response.data);
        loaddatacategory();
      });
  ...
  async function deleteData() {
    await axios
      .post(`https://api.401snkrs.com/v1/deletecategory`, { id })
      .then(function (response) {
        // console.log(response.data);
        loaddatacategory();
      });
  ...
  if (!isLoading) {
    data_category.map((data_cat: any, index: number) => {
      return list_category.push({
        id: index,
        ...
        action: (
          <div className="flex flex-warp gap-4">
            <button
              ...
              onClick={() =>
                showeditModal(data_cat.id, data_cat.category, index)
              }
            >
            ...
            <button
              ...
              onClick={() => showdeleteModal(data_cat.id, index)}
            >
      ...
      <div className="flex flex-wrap items-center content-center mb-6">
        <div className="shadow rounded-lg w-auto flex flex-row text-center content-center">
          <input
            ...
            type="text"
            placeholder="Cari data Category"
            value={filterText}
