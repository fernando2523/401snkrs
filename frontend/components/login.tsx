...
export default function Login() {
  ...
  expireTime.setTime(expireTime.getTime() + (24 * 60 * 0.9 * 1000));
      ...
      .then(function (response) {
        if (response.data.result === "Failed") {
          ...
          toast.success("Login Berhasil", {
            ...
            onClose: () => {
              router.reload();
              window.location.href = "/listbelanja/listbelanja";
      ...
      <div className="w-[500px] h-[500px] shadow-xl rounded-xl border border-gray-200 p-5 flex flex-col gap-3 hover:shadow-[0px_20px_11px_1px_#2125291A]">
        ...
        <div className="mt-5">
          <button
            ...
            type="button"
            className={`${ProcessLogin ? "bg-gray-600" : "bg-black hover:bg-gray-800"
