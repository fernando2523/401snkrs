...
const paysatuan = async (req, res) => {
  const data = req.body;
  try {
    const result = await Models.paysatuan(data);
    res.json({
      result: result,
      //   data: data,
    });
...
const payall = async (req, res) => {
  const data = req.body;
  try {
    const result = await Models.payall(data);
    res.json({
      result: result,
      //   data: data,
    });
...
const printpending = async (req, res) => {
  const data = req.body;
  try {
    const result = await Models.printpending(data);
    res.json({
      result: result,
      //   data: data,
    });
